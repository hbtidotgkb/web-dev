...
export const CakePoem = () => {
    return (
        <div>
        <Typography sx={{ ml: 2, flex: 1 }} style={{color: 'red'}} variant="h5" component="div">"A Birthday Cake"</Typography>
...
Your eyes are a reflection of shining water in a blue lake;<br></br>
<br></br>
You have a smile that's something impossible to fake;<br></br>
You are your best version so never change for other's sake;<br></br>
<br></br>
